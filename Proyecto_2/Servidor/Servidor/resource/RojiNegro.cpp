...
class ArbolRojiNegro{
  ...
  public:
    ...
    void insertarValorNodoRN(int data, 
...
void ArbolRojiNegro::insertarValorNodoRN(int num, string pIdTransporte, string pTipoTransporte, string pOrigen, string pDestino, string pFechaSalida,
                  string pHoraSalida, string pFechaLlegada, string pHoraLlegada, string pCompania, string pNumplazas,
                  string pPrecio, int pCantdeTransportes){

    NodoRojiNegro *pt = new NodoRojiNegro(num, pIdTransporte, pTipoTransporte, pOrigen, pDestino, pFechaSalida,
