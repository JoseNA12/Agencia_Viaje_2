...
class NodoAVL {
   public:
    ...
    NodoAVL(int num, string pIdHotel, string pNombre, string pCategoria, string pCiudad, string pPrecioHabIndiv,
    ...
    void InsertaAVL(int num, string pIdHotel, string pNombre, string pCategoria, string pCiudad, string pPrecioHabIndiv,
