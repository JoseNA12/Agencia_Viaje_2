...
class AVL{
  public:
    ...
    void InsertaNodoAVL(int num, string pIdHotel, string pNombre, string pCategoria, string pCiudad, string pPrecioHabIndiv,
    ...
    void InsertarBalanceado(NodoAVL *r, bool, int num, string pIdHotel, string pNombre, string pCategoria, string pCiudad, string pPrecioHabIndiv,
            string pPrecioHabDoble, int pCantHabIndiv, int pCantHabDoble);
...
void NodoAVL::InsertaAVL(int num, string pIdHotel, string pNombre, string pCategoria, string pCiudad, string pPrecioHabIndiv,
            string pPrecioHabDoble, int pCantHabIndiv, int pCantHabDoble)
{
    if(num<valor){
        if(Hizq==NULL){
            Hizq = new NodoAVL(num, pIdHotel, pNombre,  pCategoria, pCiudad,  pPrecioHabIndiv,
            pPrecioHabDoble, pCantHabIndiv, pCantHabDoble);
        }else{
            Hizq->InsertaAVL(num, pIdHotel, pNombre, pCategoria, pCiudad, pPrecioHabIndiv,
            pPrecioHabDoble, pCantHabIndiv, pCantHabDoble);
        }
    }else{
        if(Hder==NULL){
            Hder = new NodoAVL(num, pIdHotel, pNombre, pCategoria, pCiudad, pPrecioHabIndiv,
            pPrecioHabDoble, pCantHabIndiv, pCantHabDoble);
        }else{
            Hder->InsertaAVL(num, pIdHotel, pNombre, pCategoria, pCiudad, pPrecioHabIndiv,
            pPrecioHabDoble, pCantHabIndiv, pCantHabDoble);
        }
    }
}

void AVL::InsertaNodoAVL(int num, string pIdHotel, string pNombre, string pCategoria, string pCiudad, string pPrecioHabIndiv,
            string pPrecioHabDoble, int pCantHabIndiv, int pCantHabDoble)
{
    if(raiz==NULL){
        raiz = new NodoAVL(num, pIdHotel, pNombre, pCategoria, pCiudad, pPrecioHabIndiv,
            pPrecioHabDoble, pCantHabIndiv, pCantHabDoble);
    }else{
        raiz->InsertaAVL(num, pIdHotel, pNombre, pCategoria, pCiudad, pPrecioHabIndiv,
            pPrecioHabDoble, pCantHabIndiv, pCantHabDoble);
    }
}
...
void AVL::PostordenI(){
    ...
    while(!p.VaciaAVL() || Act!=NULL){
        if(Act!=NULL){
            p2.PushAVL(new NodoAVL(Act->valor, Act->idHotel, Act->nombre, Act->categoria, Act->ciudad, Act->precioHabIndiv,
...
void AVL::InsertarBalanceado(pNodoAVL ra, bool Hh, int num, string pIdHotel, string pNombre, string pCategoria, string pCiudad, string pPrecioHabIndiv,
            string pPrecioHabDoble, int pCantHabIndiv, int pCantHabDoble){
    pNodoAVL n1;

    if(raiz==NULL){
        ra=new NodoAVL(num, pIdHotel, pNombre, pCategoria, pCiudad, pPrecioHabIndiv,
            pPrecioHabDoble, pCantHabIndiv, pCantHabDoble);
        cout<<ra->valor<<endl;
        Hh = true;
    }else{
        cout<<endl;
        if(num<=ra->valor){
            InsertarBalanceado(ra->Hizq, Hh, num, pIdHotel, pNombre, pCategoria, pCiudad, pPrecioHabIndiv,
            pPrecioHabDoble, pCantHabIndiv, pCantHabDoble);
        ...
        if(Hh){
            ...
            if(num>ra->valor){
                InsertarBalanceado(ra->Hder, Hh, num, pIdHotel, pNombre, pCategoria, pCiudad, pPrecioHabIndiv,
            pPrecioHabDoble, pCantHabIndiv, pCantHabDoble);
