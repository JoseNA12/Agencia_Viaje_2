...
class NodoBinarioBusqueda {
   public:
    ...
    NodoBinarioBusqueda(int num, string pIdViaje, string pOrigen, string pDestino, string pFechaSalida, string pFechaLlegada,
    ...
    void InsertaBinarioBusqueda(int num, string pIdViaje, string pOrigen, string pDestino, string pFechaSalida,
