...
class BinarioBusqueda{
  public:
    ...
    void InsertaNodoBinarioBusqueda(int num, string pIdViaje, string pOrigen, string pDestino, string pFechaSalida,
...
void NodoBinarioBusqueda::InsertaBinarioBusqueda(int num, string pIdViaje, string pOrigen, string pDestino, string pFechaSalida,
                                string pFechaLlegada, string pPrecio, string pNumPlazas, int pCantPaquetes)
{
    if(num<valor){
        if(Hizq==NULL){
            Hizq = new NodoBinarioBusqueda(num, pIdViaje, pOrigen, pDestino, pFechaSalida, pFechaLlegada, pPrecio,
                                           pNumPlazas, pCantPaquetes);
        }else{
            Hizq->InsertaBinarioBusqueda(num, pIdViaje, pOrigen, pDestino, pFechaSalida, pFechaLlegada, pPrecio,
                                           pNumPlazas, pCantPaquetes);
        }
    }else{
        if(Hder==NULL){
            Hder = new NodoBinarioBusqueda(num, pIdViaje, pOrigen, pDestino, pFechaSalida, pFechaLlegada, pPrecio,
                                           pNumPlazas, pCantPaquetes);
        }else{
            Hder->InsertaBinarioBusqueda(num, pIdViaje, pOrigen, pDestino, pFechaSalida, pFechaLlegada, pPrecio,
                                           pNumPlazas, pCantPaquetes);
        }
    }
}

void BinarioBusqueda::InsertaNodoBinarioBusqueda(int num, string pIdViaje, string pOrigen, string pDestino, string pFechaSalida,
                                string pFechaLlegada, string pPrecio, string pNumPlazas, int pCantPaquetes)
{
    if(raiz==NULL){
        raiz = new NodoBinarioBusqueda(num, pIdViaje, pOrigen, pDestino, pFechaSalida, pFechaLlegada, pPrecio,
                                           pNumPlazas, pCantPaquetes);
    }else{
        raiz->InsertaBinarioBusqueda(num, pIdViaje, pOrigen, pDestino, pFechaSalida, pFechaLlegada, pPrecio,
                                           pNumPlazas, pCantPaquetes);
    }
}
...
void BinarioBusqueda::PostordenI(){
    ...
    while(!p.Vacia() || Act!=NULL){
        if(Act!=NULL){
            p2.Push(new NodoBinarioBusqueda(Act->valor, Act->idViaje, Act->origen, Act->destino, Act->fechaSalida,
