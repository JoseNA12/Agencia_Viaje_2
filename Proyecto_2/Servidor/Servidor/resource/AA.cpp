...
class ArbolAA{
	public:
		...
		void IniciarInsercionAA(int Numero, string pIdViaje, string pIdHotel, string pIdOferta, string pPrecioHabIndiv,
                          string pPrecioHabDoble, int pCantOfertasIndivi, int pCantOfertasDobles);
		pnodoAA InsertarAA(int Numero, pnodoAA Raiz, string pIdViaje, string pIdHotel, string pIdOferta, string pPrecioHabIndiv,
                          string pPrecioHabDoble, int pCantOfertasIndivi, int pCantOfertasDobles);
...
void ArbolAA::IniciarInsercionAA(int Numero, string pIdViaje, string pIdHotel, string pIdOferta, string pPrecioHabIndiv,
                          string pPrecioHabDoble, int pCantOfertasIndivi, int pCantOfertasDobles)
{
	if(raizAA == NULL){
		raizAA = new NodoArbolAA(Numero, pIdViaje, pIdHotel, pIdOferta, pPrecioHabIndiv,
                        pPrecioHabDoble, pCantOfertasIndivi, pCantOfertasDobles);
	}
	else{
		pnodoAA Raiz = raizAA;
		InsertarAA(Numero,Raiz, pIdViaje, pIdHotel, pIdOferta, pPrecioHabIndiv,
                        pPrecioHabDoble, pCantOfertasIndivi, pCantOfertasDobles);
	}
}

pnodoAA ArbolAA::InsertarAA(int Numero, pnodoAA Raiz, string pIdViaje, string pIdHotel, string pIdOferta, string pPrecioHabIndiv,
                          string pPrecioHabDoble, int pCantOfertasIndivi, int pCantOfertasDobles)
{
	if(Raiz == NULL){
		Raiz = new NodoArbolAA(Numero, pIdViaje, pIdHotel, pIdOferta, pPrecioHabIndiv,
                        pPrecioHabDoble, pCantOfertasIndivi, pCantOfertasDobles);
	}
	else if(Numero < Raiz->numero){
		Raiz->hizq = InsertarAA(Numero,Raiz->hizq, pIdViaje, pIdHotel, pIdOferta, pPrecioHabIndiv,
                        pPrecioHabDoble, pCantOfertasIndivi, pCantOfertasDobles);
	}
	else if(Numero > Raiz->numero){
		Raiz->hder = InsertarAA(Numero,Raiz->hder, pIdViaje, pIdHotel, pIdOferta, pPrecioHabIndiv,
                        pPrecioHabDoble, pCantOfertasIndivi, pCantOfertasDobles);
	}
	else{
